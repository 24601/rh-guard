...
7. **Lexical / GLiClass / open System One heads are not ROC-equivalent.**
   ...
   **API compatibility does not imply identical judgments**; lower ECE
   ≠ correct) is not TypeSafe Jev. Soft floors / AMBIGUOUS / p<0.5 are
