...
[waymode](https://github.com/mossburgh/waymode) is named for app-owned controls, typed actions, live Jev decisions, host permissions, and retained evidence. Empty public tree at capture; watch, not an endorsement.
