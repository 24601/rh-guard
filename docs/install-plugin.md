...
- Do not treat [Harbor](https://github.com/harbor-framework/harbor) or [jevals](https://github.com/dayhaysoos/jevals) as required to install the hooks (practices, not install dependencies). See [eval-integrity.md](eval-integrity.md).
